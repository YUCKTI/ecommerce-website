...
import Img3 from "../../assets/women/women4.jpg";
import Img4 from "../../assets/women/women3.jpg";
import Img5 from "../../assets/women/women5.jpg";
import { FaStar } from "react-icons/fa6";

const ProductsData = [
  { id: 1, img: Img1, title: "Women Ethnic", color: "white", rating: 4.3, aosDelay: "0" },
  ...
  { id: 5, img: Img5, title: "Fashion T-shirt", rating: 4.5, color: "pink", aosDelay: "800" },
];
      ...
      <div className="container">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto">
          ...
          <p data-aos="fade-up" className="text-xs text-gray-400">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit aperiam quam repellat!
          </p>
        </div>
